export function formatRelativeDate(date: Date = new Date()) {
...
export function createPastDate(date:number = 1, now: Date = new Date()): Date {
...
export function createNextId(list: {id: number}[] = []): number {
